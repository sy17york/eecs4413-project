1. download war this project.war file
2. import to your ide
3. use tomacat (9.0)  to simulate web service
4. admin user & ps : admin admin
-----
**<span style="color: blue; font-size: 20px;">there are some demo pages of admin</span>**
...
-----
**<span style="color: blue; font-size: 20px;">there are some demo pages of online store</span>**
